...
class TestHaml2Slim < Minitest::Test
  ...
  def test_data_attributes_convert
    haml = '%a{:href => "test", :data => {:param1 => var, :param2 => 1 + 1, :param3 => "string string", :param4 => :symbol, :disable_with => "..."}}'
    slim = 'a href="test" data-param1=var data-param2=(1 + 1) data-param3="string string" data-param4="symbol" data-disable-with="..."'
    assert_haml_to_slim haml, slim
  end
